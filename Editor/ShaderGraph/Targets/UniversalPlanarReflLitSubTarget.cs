...
namespace UnityEditor.Rendering.Universal.ShaderGraph
{
	...
	class UniversalPlanarReflLitSubTarget : UniversalSubTarget, ILegacyTarget
    {
        static readonly GUID kSourceCodeGuid = new GUID("9ee3e2d2d38e92d4c8c5b0996c5c0513"); // UniversalPalnarReflLitSubTarget.cs
        ...
        public UniversalPlanarReflLitSubTarget()
        {
            displayName = "Planar Reflections Lit";
        }
        ...
        public override void Setup(ref TargetSetupContext context)
        {
            ...
            // Process SubShaders
            context.AddSubShader(PostProcessSubShader(SubShaders.PlanarReflLitSubShader(target, WorkflowMode.Metallic, target.renderType, target.renderQueue, target.disableBatching, blendModePreserveSpecular)));
        }
        ...
        public override void ProcessPreviewMaterial(Material material)
        {
            if (target.allowMaterialOverride)
            {
                ...
                material.SetFloat(Property.SpecularWorkflowMode, (float)WorkflowMode.Metallic);
        ...
        public override void CollectShaderProperties(PropertyCollector collector, GenerationMode generationMode)
        {
            ...
            if (target.allowMaterialOverride)
            {
                collector.AddFloatProperty(Property.SpecularWorkflowMode, (float)WorkflowMode.Metallic);
        ...
        {
            public static SubShaderDescriptor PlanarReflLitSubShader(UniversalTarget target, WorkflowMode workflowMode, string renderType, string renderQueue, string disableBatchingTag, bool blendModePreserveSpecular)
            {
                ...
                result.passes.Add(PlanarReflLitPasses.Forward(target, workflowMode, blendModePreserveSpecular, CorePragmas.Forward, LitKeywords.Forward));

                // ForwardOnly ComplexLit fills GBuffer too for potential custom usage of the GBuffer.
                result.passes.Add(PlanarReflLitPasses.GBuffer(target, workflowMode, blendModePreserveSpecular));
                ...
                result.passes.Add(PassVariant(PlanarReflLitPasses.DepthNormal(target), CorePragmas.Instanced));

                result.passes.Add(PassVariant(PlanarReflLitPasses.Meta(target), CorePragmas.Default));
        ...
        #region Passes
        static class PlanarReflLitPasses
        {
                ...
                KeywordCollection keywords)
            {
                ...
                {
                    // Definition
                    displayName = "Planar Refl Forward",
                    ...
                    validPixelBlocks = PlanarReflLitBlockMasks.FragmentLit,

                    // Fields
                    structs = CoreStructCollections.Default,
                    requiredFields = PlanarReflLitRequiredFields.Forward,
                ...
                KeywordCollection keywords)
            {
                var result = new PassDescriptor
                {
                    ...
                    keywords = new KeywordCollection { keywords },
                    includes = new IncludeCollection { PlanarReflLitIncludes.Forward },
                ...
                if (complexLit)
                    result.defines.Add(PlanarReflLitDefines.ClearCoat, 1);
            ...
            public static PassDescriptor GBuffer(UniversalTarget target, WorkflowMode workflowMode, bool blendModePreserveSpecular)
            {
                var result = new PassDescriptor
                {
                    ...
                    // Fields
                    structs = CoreStructCollections.Default,
                    requiredFields = PlanarReflLitRequiredFields.GBuffer,
                    fieldDependencies = CoreFieldDependencies.Default,
                    ...
                    includes = new IncludeCollection { PlanarReflLitIncludes.GBuffer },
            ...
            public static PassDescriptor Meta(UniversalTarget target)
            {
                var result = new PassDescriptor()
                {
                    ...
                    // Port Mask
                    validVertexBlocks = CoreBlockMasks.Vertex,
                    validPixelBlocks = PlanarReflLitBlockMasks.FragmentMeta,

                    // Fields
                    structs = CoreStructCollections.Default,
                    requiredFields = PlanarReflLitRequiredFields.Meta,
                    fieldDependencies = CoreFieldDependencies.Default,
                    ...
                    includes = PlanarReflLitIncludes.Meta,
        ...
        #region PortMasks
        static class PlanarReflLitBlockMasks
        {
        ...
        static class PlanarReflLitRequiredFields
        {
        ...
        #region Defines
        static class PlanarReflLitDefines
        {
        ...
        #region Includes
        static class PlanarReflLitIncludes
        {
            const string kShadows = "Packages/com.unity.render-pipelines.universal/ShaderLibrary/Shadows.hlsl";
            const string kMetaInput = "Packages/com.unity.render-pipelines.universal/ShaderLibrary/MetaInput.hlsl";
            const string kForwardPass = "Assets/Shared/PlanarReflections/Editor/ShaderGraph/Includes/PlanarReflForwardPass.hlsl"; //"Packages/com.unity.render-pipelines.universal/Editor/ShaderGraph/Includes/PBRForwardPass.hlsl";
            const string kGBuffer = "Packages/com.unity.render-pipelines.universal/ShaderLibrary/GBufferOutput.hlsl";
            const string kPBRGBufferPass = "Assets/Shared/PlanarReflections/Editor/ShaderGraph/Includes/PlanarReflGBufferPass.hlsl"; //"Packages/com.unity.render-pipelines.universal/Editor/ShaderGraph/Includes/PBRGBufferPass.hlsl";
...
#endif  // ENABLE_PLANAR_REFLECTIONS_IN_SHADERGRAPH
